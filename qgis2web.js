...
map.getView().fit([3795655.116167, 3659511.058644, 3871355.909743, 3710143.720577], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">توزيع الجامعات - قطاع غزة</h2>';
        return titleElement;
    })(),
